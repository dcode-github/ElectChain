        ...
        <Col span={20}>
          <Card>
            <Row gutter={16}>
              ...
              <Col span={18}>
                <Title level={4} style={{ color: '#1890ff', fontWeight: 'bold' }}>{userData.name}</Title>
                <Text style={{ display: 'block', fontSize: '16px' }}>{userData.email}</Text>
                <Text style={{ display: 'block', fontSize: '16px' }}>Ethereum Address: {userData.address}</Text>
                <Text style={{ display: 'block', fontSize: '16px' }}>Age: {userData.age}</Text>
